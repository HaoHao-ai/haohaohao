...
with open('C:\\Users\\Lenovo\\Desktop\\Weibo Data\\weibo_train_data.txt', 'r', encoding='utf-8') as file:
    for line in file:
        try:
...
with open('C:\\Users\\Lenovo\\Desktop\\Weibo Data\\weibo_predict_data.txt', 'r', encoding='utf-8') as file:
    for line in file:
        try:
            row = line.strip().split('\t')
...
# 将新数据框保存为 txt 文件
result_df.to_csv(r'C:\\Users\\Lenovo\\Desktop\\Weibo Data\\weibo_result_data.txt', sep='\t', index=False)